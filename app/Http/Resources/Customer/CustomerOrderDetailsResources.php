...
use App\Http\Resources\Customer\OrderMealsResources;
use Illuminate\Http\Resources\Json\JsonResource;
use mysql_xdevapi\Collection;


class CustomerOrderDetailsResources extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return
            [
                ...
                'meals' => isset($this->orderMeals) ? (OrderMealsResources::collection($this->orderMeals)) : [],
//                'user' => $this->user,
                'restaurant' => new RestaurantResources($this->restaurant),
            ];
    }
}
