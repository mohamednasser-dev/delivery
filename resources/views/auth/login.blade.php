...
<head>
    ...
    <link href="{{asset('metronic/assets/plugins/custom/prismjs/prismjs.bundle.rtl.css')}}" rel="stylesheet"
          type="text/css"/>
...
<div class="d-flex flex-column flex-root">
    ...
    <div class="login login-4 wizard d-flex flex-column flex-lg-row flex-column-fluid">
        ...
        <div
            ...
            style="background-image: url({{asset('/metronic/assets/media/bg/bg2.jpg')}});">
            <!--begin::Wrapper-->
            <div class="login-content d-flex flex-column pt-lg-0 pt-12">
                <!--begin::Logo-->
                <a href="#" class="login-logo pb-xl-20 pb-15">
                    <img src="{{url('/')}}/red logo.svg" class="max-h-70px" alt=""/>
                </a>
                <!--end::Logo-->
                <!--begin::Signin-->
                ...
                <!--begin::Title-->
                    <div class="pb-5 pb-lg-15">
                        <h3 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg">{{__('admin.login')}}</h3>
                    </div>
                    <!--begin::Title-->
                    <!--begin::Form group-->
                    <div class="form-group">
                        <label class="font-size-h6 font-weight-bolder text-dark">{{__('admin.email')}}</label>
                        <input
                            class="form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0 @error('national_id') is-invalid @enderror"
                            id="national_id" type="email" name="email" placeholder="{{__('admin.email')}}  "
                    ...
                    <div class="form-group">
                        <div class="d-flex justify-content-between mt-n5">
                            <label
                                class="font-size-h6 font-weight-bolder text-dark pt-5"> {{__('admin.password')}} </label>
                        ...
                        <input
                            ...
                            id="password" type="password" name="password" placeholder=" {{__('admin.password')}} "
                    ...
                    <div class="kt-login__extra">
                        <label class="kt-checkbox">
                            <input type="checkbox" name="remember"> {{__('admin.remember')}}
                            <span></span>
                        </label>
                    </div>
                    <!--begin::Action-->
                    <div class="pb-lg-0 pb-5">
                        <button type="submit" id="kt_login_singin_form_submit_button"
                                class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">{{__('admin.login')}}</button>
                    </div>
                    <!--end::Action-->
                {{ Form::close() }}
                <!--end::Form-->
        ...
        <div class="login-aside order-1 order-lg-2 bgi-no-repeat bgi-position-x-right">
            <div class="login-conteiner bgi-no-repeat bgi-position-x-right bgi-position-y-bottom"
                 style="background-image: url({{asset('/metronic/assets/media/svg/illustrations/login.svg')}});">
