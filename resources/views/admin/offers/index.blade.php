                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-hover table-checkable" id="kt_datatable">
                        ...
                        <tr>
                            ...
                            <th class="center">{{trans('lang.offer_type')}}</th>
                            <th class="center">{{trans('lang.target')}}</th>
                        ...
                        @foreach($data as $key => $row)
                            <tr>
                                ...
                                <td class="center">{{trans('lang.'.$row->target_type)}}</td>
                                <td class="center">
                                    @if($row->target_type == \App\Models\Restaurant::class)
                                        {{$row->restaurant ?$row->restaurant->name : ''}}
                                    @else
                                        {{$row->meal ?$row->meal->name : ''}}
                                    @endif
                                </td>
